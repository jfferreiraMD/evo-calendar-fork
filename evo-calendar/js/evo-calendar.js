...
(function (factory) {
  ...
  EvoCalendar = (function () {
      ...
      function EvoCalendar(element, settings) {
          ...
          _.onDayHover = $.proxy(_.onDayHover, _);
          _.onDayHoverOut = $.proxy(_.onDayHoverOut, _);
  ...
  EvoCalendar.prototype.destroyEventListener = function () {
      ...
      // remove hover event listener for each day
      _.$elements.innerEl.find(".calendar-day").off("mouseenter.evocalendar mouseleave.evocalendar");
  };
  ...
  EvoCalendar.prototype.buildTheBones = function () {
      ...
      if (!_.$elements.calendarEl.html()) {
          ...
          // events
          markup += '<div class="calendar-events">' + '<div class="event-header"><p></p></div>' + '<div class="event-list"></div>' + "</div>";
  ...
  EvoCalendar.prototype.selectDate = function (event) {
      ...
      var date, activeDayEl;
      if (typeof event !== 'object' || event instanceof Date) {
          date = _.formatDate(new Date(event), _.options.format);
          _.selectYear(new Date(date).getFullYear());
          _.selectMonth(new Date(date).getMonth());
      ...
      var eventIds = activeDayEl.data("eventId");
  ...
  EvoCalendar.prototype.onDayHover = function (event) {
      var _ = this;
